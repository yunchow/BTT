...
public class Main {
	...
	public static void main(String[] args) {
		...
		Mover trainA = new Mover("trainA", new BigDecimal("150").divide(new BigDecimal("60"), MathUtil.SCALE, ROUND_HALF_UP), new BigDecimal("0"), Direction.RIGHT); // 150公里/小时，即150/60公里/分钟
		Mover trainB = new Mover("trainB", new BigDecimal("200").divide(new BigDecimal("60"), MathUtil.SCALE, ROUND_HALF_UP), new BigDecimal("120"), Direction.LEFT);
		Bird bird = new Bird("bird", new BigDecimal("400").divide(new BigDecimal("60"), MathUtil.SCALE, ROUND_HALF_UP), new BigDecimal("0"), Direction.RIGHT);
